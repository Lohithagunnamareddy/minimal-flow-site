    ...
    <footer className="bg-white border-t border-gray-200 mt-auto">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-bold text-gray-900 mb-4">Campus Bridge</h3>
            <p className="text-gray-600">
              Connecting students, faculty, and administrators for a seamless academic experience.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-600">Email: info@campusbridge.com</li>
              <li className="text-gray-600">Phone: (555) 123-4567</li>
              <li className="text-gray-600">Address: 123 University Ave, Academic City</li>
            </ul>
          </div>
        </div>
        
        <div className="border-t border-gray-200 mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-gray-600 text-sm">© {new Date().getFullYear()} Campus Bridge. All rights reserved.</p>
